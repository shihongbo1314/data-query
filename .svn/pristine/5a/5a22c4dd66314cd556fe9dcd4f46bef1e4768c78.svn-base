<template>
    <div class="dataQueryDiv">
        ...
        >
            ...
            <div
                :class="!leftShow ? 'secondbox1':'secondbox'"
                @click="getStationData(3)"
            >
                <span>确定查询</span>
            </div>
            ...
            >
                ...
                <el-dialog
                    ...
                    style="left:35%"
                >
                    <div style="font-size:16px;margin: 10px 0;">要素:{{this.treeData.label | getZW}}</div>
...
export default {
    ...
    methods: {
        ...
        Setdefault() {
            ...
            switch (this.radio) {
                case "cool_max_box":
                    colorDataJson = this.cool_max_box;
                    break;
                case "warm_max_box":
                    colorDataJson = this.warm_max_box;
                    break;
                case "cool_min_box":
                    colorDataJson = this.cool_min_box;
                    break;
                case "warm_min_box":
                    colorDataJson = this.warm_min_box;
                    break;
                case "custom_styly_box":
                    this.custom_styly_box.map((item) => {
                        item.r = item.value.split(",")[0].slice(4);
                        item.g = item.value.split(",")[1].slice(0);
                        item.b = item.value.split(",")[2].slice(0, -1);
                        delete item.value;
                    });
                    colorDataJson = this.custom_styly_box;
                    break;
                default:
                    break;
            }
