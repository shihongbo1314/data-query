...
export default {
    ...
    methods: {
        ...
        deptNodeClick2(data) {
            ...
            this.$emit("setCheckedKeys", currentNode.data.value,currentNode.data.label,currentNode.data.imagehour,currentNode.data.imageelement);
        },
        changetype() {
            if (this.type == 1) {
                this.defaultTree = [0];
                ...
                this.$refs.tree.setCheckedNodes([
                    {
                        ...
                        label: this.arr[0].children[0].label,
                    },
                ]);
                console.log(this.arr[0].children[0])
                this.$emit("setCheckedKeys",this.arr[0].children[0].value,this.arr[0].children[0].label,this.arr[0].children[0].imagehour,this.arr[0].children[0].imageelement);
            }
